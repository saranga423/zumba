            ...
            <div className="hidden lg:flex items-center gap-1">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="px-3 py-2 text-sm font-medium text-[#FAF4E9]/80 hover:text-[#FF9736] transition-colors relative group no-underline focus-visible:outline-2 focus-visible:outline-[#C8F03C] focus-visible:outline-offset-2 rounded"
                >
                  {link.label}
            ...
            <div className="flex flex-col items-center gap-4 p-8">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="font-[Bricolage_Grotesque] font-bold text-3xl sm:text-4xl text-[#FAF4E9] hover:text-[#FF9736] transition-colors tracking-wide no-underline"
                >
                  {link.label}
                </motion.a>
              ))}
